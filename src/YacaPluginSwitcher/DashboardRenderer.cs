...
public partial class MainWindow
{
    ...
    private static readonly string LatestBackupFolderIconData = "M 5 6 H 10 L 13 9 H 20 C 21.1 9 22 9.9 22 11 V 18 C 22 19.1 21.1 20 20 20 H 4 C 2.9 20 2 19.1 2 18 V 8 C 2 6.9 2.9 6 4 6 Z M 15.5 14.5 A 4.5 4.5 0 1 0 16.5 17.5 M 15.5 12 V 15 H 18.5";
    ...
    private void BuildCurrentInstalledPanel(Grid host, int column)
    {
        ...
        _currentValue = new TextBlock { Text = "—", FontSize = DashboardVersionFontSize, FontWeight = FontWeights.SemiBold, HorizontalAlignment = HorizontalAlignment.Center, TextAlignment = TextAlignment.Center, Foreground = gold };
    ...
    private void BuildLatestBackupPanel(Grid host, int column)
    {
        ...
        {
            Data = Geometry.Parse(LatestBackupFolderIconData),
    ...
    private Brush GetVersionRowBackground(int index)
    {
        ...
        if (FindResource("SurfaceBrush") is SolidColorBrush surface)
        {
            return new SolidColorBrush(Color.FromArgb(24, surface.Color.R, surface.Color.G, surface.Color.B));
        }
    ...
    private void UpdateBackupSummary(BackupInfo? backup)
    {
        ...
        _backupSummary.Inlines.Add(new LineBreak());
        _backupSummary.Inlines.Add(new Run($"{(IsGerman ? "Datei" : "File")}    {backup.FileName}")
        {
            FontSize = 15,
            Foreground = (Brush)FindResource("ForegroundBrush")
        });
        _backupSummary.Inlines.Add(new LineBreak());
        _backupSummary.Inlines.Add(new Run($"{(IsGerman ? "Größe" : "Size")}    {backup.FileSize / 1024d / 1024d:0.00} MB")
        {
            FontSize = 15,
            Foreground = (Brush)FindResource("ForegroundBrush")
        });
