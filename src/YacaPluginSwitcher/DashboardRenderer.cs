...
public partial class MainWindow
{
    ...
    private void BuildCurrentInstalledPanel(Grid host, int column)
    {
        ...
        {
            Text = "—", FontSize = DashboardVersionFontSize, FontWeight = FontWeights.SemiBold,
        ...
        var activeBadge = new Border
        {
            ...
            CornerRadius = new CornerRadius(0), MinHeight = 30,
            Padding = new Thickness(16, 4, 16, 4), Margin = new Thickness(0, 10, 0, 0),
            HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center,
            Child = new TextBlock
            {
                Text = IsGerman ? "AKTIV" : "ACTIVE", Foreground = Brushes.Black,
                FontSize = DashboardBadgeFontSize, FontWeight = FontWeights.Bold,
        ...
        {
            FontSize = 13, LineHeight = 20, Foreground = (Brush)FindResource("ForegroundBrush"),
            TextAlignment = TextAlignment.Left, HorizontalAlignment = HorizontalAlignment.Left, TextWrapping = TextWrapping.NoWrap
        };
        _currentShaLabel = new TextBlock
        {
            FontSize = 13, FontWeight = FontWeights.SemiBold, Foreground = (Brush)FindResource("ForegroundBrush"),
            TextAlignment = TextAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center, Margin = new Thickness(0, 8, 0, 3)
        };
        var shaSeparator = new Border
        {
            Height = 1, Background = (Brush)FindResource("ForegroundBrush"), Opacity = 0.65,
            HorizontalAlignment = HorizontalAlignment.Stretch, Margin = new Thickness(0, 0, 0, 5)
        };
        _currentShaValue = new TextBlock
        {
            FontSize = 11, Foreground = (Brush)FindResource("ForegroundBrush"),
            TextAlignment = TextAlignment.Left, HorizontalAlignment = HorizontalAlignment.Left, TextWrapping = TextWrapping.NoWrap
        };
        Grid.SetRow(_currentMetaText, 0);
        Grid.SetRow(_currentShaLabel, 1);
        Grid.SetRow(shaSeparator, 2);
        Grid.SetRow(_currentShaValue, 3);
        _currentDetailsPanel.Children.Add(_currentMetaText);
        _currentDetailsPanel.Children.Add(_currentShaLabel);
        _currentDetailsPanel.Children.Add(shaSeparator);
    ...
    private void BuildTeamSpeakPanel(Grid host, int column)
    {
        ...
        _teamSpeakStatusIcon = DashboardIconRegistry.CreateIcon(DashboardIconRegistry.IconAssetTeamSpeakStopped,
            (Brush)FindResource("GoldBrush"), 44, 44);
        ...
        {
            Text = "—", FontSize = 28, FontWeight = FontWeights.SemiBold,
            HorizontalAlignment = HorizontalAlignment.Left, Foreground = gold
        };
        _tsDescription = new TextBlock
        {
            FontSize = 14, Foreground = (Brush)FindResource("SecondaryBrush"), TextWrapping = TextWrapping.NoWrap,
            TextAlignment = TextAlignment.Left, Margin = new Thickness(0, 10, 0, 0), MaxWidth = 420
        };
        textPanel.Children.Add(_tsStatus);
        textPanel.Children.Add(_tsDescription);
        ...
        _tsClose = new Button
        {
            ...
            Background = (Brush)FindResource("ErrorBrush"), Foreground = Brushes.White,
            BorderBrush = (Brush)FindResource("ErrorBrush"), BorderThickness = new Thickness(0),
            Padding = new Thickness(18, 8, 18, 8), HorizontalAlignment = HorizontalAlignment.Center,
            Margin = new Thickness(0, 8, 0, 0), Cursor = System.Windows.Input.Cursors.Hand,
    ...
    private void BuildAvailableVersionsPanel(Grid host, int column)
    {
        ...
        var header = CreateDashboardHeader(DashboardIconRegistry.IconAssetBackups,
            IsGerman ? "VERFÜGBARE VERSIONEN" : "AVAILABLE VERSIONS", purple);
        Grid.SetRow(header, 0);
        panel.Children.Add(header);
        ...
        var footer = new Grid
        {
            Margin = new Thickness(6, 0, 6, 2), Cursor = System.Windows.Input.Cursors.Hand,
        ...
        {
            Text = "0", FontSize = DashboardFooterFontSize, Foreground = purple, Background = Brushes.Transparent,
            HorizontalAlignment = HorizontalAlignment.Left, VerticalAlignment = VerticalAlignment.Center,
            Padding = new Thickness(8, 4, 8, 4), IsHitTestVisible = false
        };
        Grid.SetColumn(footerText, 0);
        footer.Children.Add(footerText);
        var footerArrow = new System.Windows.Shapes.Path
        {
            Data = Geometry.Parse("M 2 2 L 8 8 L 2 14"), Stroke = purple, StrokeThickness = 2.2,
            Fill = Brushes.Transparent, Width = 18, Height = 18, Stretch = Stretch.Uniform,
            HorizontalAlignment = HorizontalAlignment.Right, VerticalAlignment = VerticalAlignment.Center,
            Margin = new Thickness(8, 0, 8, 0), IsHitTestVisible = false
        };
        Grid.SetColumn(footerArrow, 1);
        footer.Children.Add(footerArrow);
    ...
    private Grid CreateDashboardHeader(string iconAssetKey, string text, Brush? headerBrush = null)
    {
        ...
        {
            Text = text, FontSize = DashboardHeaderFontSize, FontWeight = FontWeights.SemiBold,
            Foreground = brush, VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(10, 0, 0, 0)
        });
        Grid.SetRow(content, 0);
        header.Children.Add(content);
        var separator = new Border
        {
            Height = 1, Background = brush, Opacity = 0.65, Margin = new Thickness(0, 8, 0, 0),
            HorizontalAlignment = HorizontalAlignment.Stretch
        };
    ...
    private void AddDashboardTile(Grid host, int column, string iconAssetKey, string title, string subtitle, Brush accent, Action action)
    {
        ...
        {
            Style = (Style)FindResource("TileButtonStyle"), Background = surface, Foreground = accent,
            BorderBrush = accent, BorderThickness = new Thickness(1), Margin = new Thickness(6)
        };
        ...
        {
            Text = title, FontSize = DashboardTileTitleFontSize, FontWeight = FontWeights.Bold, Foreground = accent,
            HorizontalAlignment = HorizontalAlignment.Center, Margin = new Thickness(0, 8, 0, 4)
        });
        panel.Children.Add(new TextBlock
        {
            Text = subtitle, FontSize = DashboardTileSubtitleFontSize,
            Foreground = (Brush)FindResource("SecondaryBrush"), TextAlignment = TextAlignment.Center, TextWrapping = TextWrapping.NoWrap
        });
    ...
    private void BuildLatestBackupPanel(Grid host, int column)
    {
        ...
        {
            FontSize = 15, LineHeight = 22, Foreground = (Brush)FindResource("ForegroundBrush"),
            TextWrapping = TextWrapping.NoWrap, VerticalAlignment = VerticalAlignment.Center,
            HorizontalAlignment = HorizontalAlignment.Left, TextAlignment = TextAlignment.Left, Margin = new Thickness(0, 0, 10, 0)
        };
        Grid.SetColumn(_backupSummary, 0);
        content.Children.Add(_backupSummary);
        var backupIcon = DashboardIconRegistry.CreateIcon(DashboardIconRegistry.IconAssetBackup, purple, 132, 132);
        backupIcon.VerticalAlignment = VerticalAlignment.Center;
        Grid.SetColumn(backupIcon, 1);
        content.Children.Add(backupIcon);
        Grid.SetRow(content, 1);
        panel.Children.Add(content);
        card.Child = panel;
        Grid.SetColumn(card, column);
    ...
    private void RenderVersionList(YacaPluginInfo? current)
    {
        ...
        for (var index = 0; index < ordered.Count; index++)
        {
            ...
            var row = new Border
            {
                Background = GetVersionRowBackground(index),
                CornerRadius = new CornerRadius(0), Padding = new Thickness(7, 2, 7, 2), Margin = new Thickness(0, 1, 0, 1)
            };
            ...
            {
                Text = $"YACA {plugin.Version} - (Build: {plugin.Build?.ToString(CultureInfo.InvariantCulture) ?? "—"})",
                FontSize = DashboardVersionListFontSize, FontWeight = FontWeights.SemiBold, VerticalAlignment = VerticalAlignment.Center
            });
            if (current?.Sha256.Equals(plugin.Sha256, StringComparison.OrdinalIgnoreCase) == true)
            {
                var badge = new Border
                {
                    Background = (Brush)FindResource("SuccessBrush"), CornerRadius = new CornerRadius(0),
                    Padding = new Thickness(7, 2, 7, 2), MinHeight = 24, VerticalAlignment = VerticalAlignment.Center,
                    Margin = new Thickness(10, 0, 0, 0),
                    Child = new TextBlock
                    {
                        Text = IsGerman ? "INSTALLIERT" : "INSTALLED", Foreground = Brushes.Black,
        ...
        {
            _versionsFooterText.Text = IsGerman
    ...
    private void UpdateBackupSummary(BackupInfo? backup)
    {
        ...
        var statusText = backup.IsAutomatic
            ? (IsGerman ? "Automatisches Backup" : "Automatic Backup")
            : (IsGerman ? "Manuelles Backup" : "Manual Backup");
        var buildText = backup.SourceBuild?.ToString(CultureInfo.InvariantCulture) ?? "—";
        var sizeBytes = backup.FileSize;
        ...
        {
            FontSize = 34, FontWeight = FontWeights.SemiBold, Foreground = (Brush)FindResource("GoldBrush")
        });
        _backupSummary.Inlines.Add(new LineBreak());
        _backupSummary.Inlines.Add(new Run(" ") { FontSize = 8 });
        _backupSummary.Inlines.Add(new LineBreak());
        _backupSummary.Inlines.Add(new Run($"{versionText} • (Build: {buildText})")
        {
            FontSize = 20, FontWeight = FontWeights.SemiBold, Foreground = foreground
        });
        _backupSummary.Inlines.Add(new LineBreak());
        _backupSummary.Inlines.Add(new Run(" ") { FontSize = 8 });
        _backupSummary.Inlines.Add(new LineBreak());
        _backupSummary.Inlines.Add(new Run($"Status: {statusText}")
        {
            FontSize = 16, FontWeight = FontWeights.SemiBold, Foreground = foreground
        });
        _backupSummary.Inlines.Add(new LineBreak());
        _backupSummary.Inlines.Add(new Run($"Größe: {sizeMb:0.00} MB ({sizeBytes.ToString("N0", CultureInfo.GetCultureInfo("de-DE"))} Bytes)")
        {
            FontSize = 15, Foreground = foreground
        });
    }
...
internal sealed class DashboardDetailsTextBlock : TextBlock
{
    ...
    internal DashboardDetailsTextBlock(Action<string> onTextChanged)
    {
        ...
        DependencyPropertyDescriptor.FromProperty(TextBlock.TextProperty, typeof(TextBlock))
            ?.AddValueChanged(this, (_, _) => _onTextChanged(Text));
    }
}
