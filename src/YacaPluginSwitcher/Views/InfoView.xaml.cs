...
public partial class InfoView : UserControl
{
    ...
    private void Build()
    {
        ...
        YacaLinks.ItemsSource = _german ? new[] { new LinkItem("YACA Homepage", "https://yaca.systems/"), new LinkItem("YACA Downloads", "https://yaca.systems/download"), new LinkItem("YACA Lizenzen", "https://yaca.systems/licenses"), new LinkItem("YACA FAQ", "https://yaca.systems/faq"), new LinkItem("YACA Discord", "https://discord.yaca.systems/") } : new[] { new LinkItem("YACA Homepage", "https://yaca.systems/"), new LinkItem("YACA Downloads", "https://yaca.systems/download"), new LinkItem("YACA Licenses", "https://yaca.systems/licenses"), new LinkItem("YACA FAQ", "https://yaca.systems/faq"), new LinkItem("YACA Discord", "https://discord.yaca.systems/") };
        TsLinks.ItemsSource = _german ? new[] { new LinkItem("TeamSpeak Homepage", "https://www.teamspeak.com/de/"), new LinkItem("TeamSpeak 3 Downloads", "https://www.teamspeak.com/de/downloads/?product=ts3"), new LinkItem("TeamSpeak Support", "https://support.teamspeak.com/hc/de") } : new[] { new LinkItem("TeamSpeak Homepage", "https://www.teamspeak.com/en/"), new LinkItem("TeamSpeak 3 Downloads", "https://www.teamspeak.com/en/downloads/?product=ts3"), new LinkItem("TeamSpeak Support", "https://support.teamspeak.com/hc/en-us") };
