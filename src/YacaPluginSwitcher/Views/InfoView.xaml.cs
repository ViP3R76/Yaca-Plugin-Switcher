...
public partial class InfoView : UserControl
{
    ...
    private void Build(){YacaDescription.Text=_german?"YACA stellt das Plugin bereit, das dieser Switcher verwaltet.":"YACA provides the plugin managed by this switcher.";TsDescription.Text=_german?"Für dieses Tool ist ausdrücklich der TeamSpeak 3 Client erforderlich – nicht TeamSpeak 6.":"This tool specifically requires the TeamSpeak 3 client, not TeamSpeak 6.";YacaLinks.ItemsSource=new[]{("YACA Homepage","https://yaca.systems/"),("YACA Licenses","https://yaca.systems/licenses"),("YACA Terms of Service","https://yaca.systems/tos"),("YACA FAQ","https://yaca.systems/faq"),("YACA Discord","https://discord.yaca.systems/")};TsLinks.ItemsSource=new[]{("TeamSpeak Homepage","https://www.teamspeak.com/"),("TeamSpeak 3 Client","https://teamspeak.com/de/downloads?product=ts3"),("TeamSpeak Support","https://support.teamspeak.com/")};LegalText.Text=_german?"YACA und TeamSpeak 3 sind Drittanbieter-Produkte. Diese Anwendung ist nicht mit YACA oder TeamSpeak Systems GmbH verbunden, wird nicht von ihnen unterstützt, gesponsert oder empfohlen.":"YACA and TeamSpeak 3 are third-party products. This application is not affiliated with, endorsed, sponsored, or recommended by YACA or TeamSpeak Systems GmbH.";}
