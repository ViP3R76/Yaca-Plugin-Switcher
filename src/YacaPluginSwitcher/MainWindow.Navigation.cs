...
public partial class MainWindow
{
    ...
    private void BuildNavigation()
    {
        ...
        AddNav(
            "home",
            DashboardIconRegistry.IconAssetDashboard,
            "Dashboard",
            ShowHome);

        AddNav(
            "refresh",
            DashboardIconRegistry.IconAssetRefresh,
            IsGerman ? "Aktualisieren" : "Refresh",
            () =>
            {
                SetGlobalStatus(
                    IsGerman ? "Aktualisierung wird ausgeführt …" : "Refreshing …");
        ...
        AddNav(
            ...
            IsGerman ? "Backup verwalten" : "Manage Backups",
            ShowBackups);
        ...
        AddNav(
            "info",
            DashboardIconRegistry.IconAssetInfo,
            "Info & Links",
            ShowInfo);
        ...
        ConfigureNavContent(
            ExitNavContent,
            DashboardIconRegistry.IconAssetExit,
    ...
    /// </summary>
    private static void ConfigureNavContent(
        StackPanel content,
        string iconAssetKey,
        string text,
        Brush? iconBrush = null)
    {
        ...
        content.Children.Add(
            DashboardIconRegistry.CreateIcon(
                iconAssetKey,
                foregroundBrush,
                30,
                30));
    ...
    private void SetActiveNav(string key)
    {
        ...
        foreach (var item in _navButtons)
        {
            ...
            if (item.Button.Content is StackPanel panel
                && panel.Children
                    .OfType<Image>()
                    .FirstOrDefault() is { } icon)
            {
