...
public partial class MainWindow
{
    ...
    /// <summary>
    /// Ergänzt den Einstellungs-Navigationseintrag an der zentral vorgesehenen Stelle.
    /// </summary>
    ...
    /// <summary>
    /// Synchronisiert den TeamSpeak-Zustand mit dem zentral erzeugten Dashboard.
    /// </summary>
    private void ApplyTeamSpeakVisualState()
    {
        ...
        if (_tsStatus.Parent is StackPanel textPanel)
        {
            ...
            var description = textPanel.Children
                .OfType<TextBlock>()
                .FirstOrDefault(text => !ReferenceEquals(text, _tsStatus));
        ...
        var natural = DashboardIconRegistry.CreateNaturalIcon(
            desiredAsset,
            44,
            44);
    ...
    /// <summary>
    /// Aktualisiert ausschließlich die dynamischen Updater-Anzeigen.
    /// Die Button-Optik kommt vollständig aus dem globalen UpdateSearchButtonStyle.
    /// </summary>
    ...
    private void EnsureUpdaterStepPanel()
    {
            ...
            || !parent.Children.Contains(_rendererUpdaterStepPanel))
        {
            ...
            var names = IsGerman
                ? ["Download", "Extraktion", "Prüfung", "Validierung", "Verschieben", "Download löschen"]
                : ["Download", "Extraction", "Check", "Validation", "Move", "Delete download"];
            ...
            parent.Children.Insert(
                Math.Max(0, progressIndex + 1),
                _rendererUpdaterStepPanel);
        }
    ...
    private void SuppressUpdaterFooterWhenAlreadyOnUpdaterPage()
    {
        ...
        if (GlobalFooterStatusText.Text.Contains(
                "YACA Updater",
                StringComparison.OrdinalIgnoreCase))
        {
